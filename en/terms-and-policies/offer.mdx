...
3.14 The Customer may top up the additional balance beyond the usage volume included in the selected Plan. A service fee charged by the Contractor for processing the top-up is added to the amount credited to the additional balance. The current service fee is displayed in the Platform interface within the top-up form before payment confirmation and is stated as a separate line item in the issued invoice. The amount credited to the additional balance equals the amount specified by the Customer in the top-up form, excluding the service fee. The Contractor may change the service fee in the manner provided for in clause 3.12 of this Offer.
