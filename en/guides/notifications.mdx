...
<Frame>
  <img src="/assets/images/uvedomleniya.png" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Notifications + Quick Answers">
    Quick Answers handle routine situations automatically (sending addresses, schedules, etc.), while notification triggers bring in a human for non-standard cases.

    Quick Answers also have a **Send notification** toggle — you can enable it for critical Quick Answers (e.g., when a complaint-related Quick Answer is triggered).

    **Tip:** Use Quick Answers for standard situations and notification triggers for non-standard ones.
  </Accordion>
