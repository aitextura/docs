...
<CardGroup cols={2}>
  ...
  <Card title="Referral Program" icon="gift" href="/en/guides/referral">
...
<Frame><img src="/assets/images/en/screenshots/finance_1.png" /></Frame>
...
| Factor | Impact |
|---|---|
| **AI employee response length** | Longer responses use more words. Adjust in [Additional Settings](/en/guides/additional-settings) |
| **Conversation context** | Longer conversations consume more — the AI considers previous messages |
| [Knowledge](/en/guides/knowledge) | Querying the knowledge base increases usage |
...
<Steps>
  <Step title="Shorten response length">
    Add an instruction to the [Persona](/en/guides/persona) tone: "reply briefly, no more than 2-3 sentences." This can reduce word usage significantly.
  </Step>
