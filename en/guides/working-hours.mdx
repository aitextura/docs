...
<Frame>
  <img src="/public/screenshots/39-agent-worktime.png" alt="Agent 'Working Hours' tab — schedule by day of week and timezone" />
</Frame>
...
<iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/2dyopQSubXk" title="Working hours — AI employee schedule setup" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
